...
const fetchLeaders = async() => {
    try{
        ...
        console.log("leaders list:", leaders)
        return leaders;
    } catch(error) {
...
// Practise code for the catch and then and callback
...
// this code works. I love it
// const checkSchool = (school) => {
//     return new Promise((resolve, reject) => {
//         if (school === "Byui" || school === "Ensign College") {
//             resolve('Welcome to ' + school);
//         } else{
//             reject('School not recognized ' + school);
//         }
//     })
// }
...
//  }
//  grantAccess()
// checkSchool('Ensign College')
//     .then((report) => {
//     let student = prompt('Enter User Name: ');
//     console.log(`${student},  ${report}`);
// }).catch((report) => {
//     console.log("Error Report catched: " + report);
// })
// I understand the catch() function now.

// Practising async await with kyle
// async function dowork(){
//     const response = await checkSchool("Ensign College")
//     console.log("Response Received")
//     const grantAcc = await grantAccess(access)
